...
import { debounce, getVersion, nFormatter } from "@jitsi/excalidraw/utils";
import {
  getElementsStorageSize,
  getTotalStorageSize,
} from "./data/localStorage";
import { DEFAULT_VERSION } from "@jitsi/excalidraw/constants";
import { t } from "@jitsi/excalidraw/i18n";
import { copyTextToSystemClipboard } from "@jitsi/excalidraw/clipboard";
import type { NonDeletedExcalidrawElement } from "@jitsi/excalidraw/element/types";
import type { UIAppState } from "@jitsi/excalidraw/types";
import { Stats } from "@jitsi/excalidraw";
