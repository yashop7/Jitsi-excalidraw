...
slug: /@jitsi/excalidraw/api/children-components
---
...
- [MainMenu](/docs/@jitsi/excalidraw/api/children-components/main-menu)
- [WelcomeScreen](/docs/@jitsi/excalidraw/api/children-components/welcome-screen)
- [Sidebar](/docs/@jitsi/excalidraw/api/children-components/sidebar)
- [Footer](/docs/@jitsi/excalidraw/api/children-components/footer)
- [LiveCollaborationTrigger](/docs/@jitsi/excalidraw/api/children-components/live-collaboration-trigger)
